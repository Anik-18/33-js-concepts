...
<br>
  ...
  <br>
    <br>
  33 টি ধারণা, যা প্রতিটি JavaScript ডেভেলপারের জানা উচিত
  <br><br>
</h1>

[![আমাকে অনুসরণ করুন](https://img.shields.io/twitter/follow/leonardomso.svg?style=for-the-badge)](https://twitter.com/leonardomso)

## পরিচয়

এই রিপোজিটরি তৈরি করা হয়েছে যেটার উদ্দেশ্য হলো ডেভেলপারদের জাভাস্ক্রিপ্টের ধারণা পরিপন্ন করতে সাহায্য করা। এটি কোনো বাধ্যতা নয়, বরং ভবিষ্যতের অধ্যয়নের জন্য একটি গাইড। এটা একটি আর্টিকেল এর উপর ভিত্তি করে তৈরি করা হয়েছে যা লিখেছেন [স্টিফেন কার্টিস](https://twitter.com/stephenthecurt) এবং আপনি এটি পড়তে পারেন [এখান থেকে](https://medium.com/@stephenthecurt/33-fundamentals-every-javascript-developer-should-know-13dd720a90d1).

**🚀 GitHub দ্বারা এটিকে একটি অন্যতম ওপেন সোর্স প্রজেক্ট হিসাবে বিবেচনা করা হয়েছে [২০১৮ সালের শীর্ষ ওপেন সোর্স প্রজেক্টগুলির মধ্যে!](https://blog.github.com/2018-12-13-new-open-source-projects/)**

## কমিউনিটি

আপনার নিজের রিক্যাপ বা রিভিউতে একটি লিঙ্ক যোগ করে নির্দ্বিধায় একটি পুল রিকুয়েস্ট জমা দিন। যদি আপনি এই রিপোজিটরি আপনার মাতৃভাষায় অনুবাদ করতে ইচ্ছুক হন তাহলে, সেটি করার জন্য আপনাকে স্বাগতম।

এই রিপোজিটরির সমস্ত অনুবাদগুলি নিম্নে তালিকাভুক্ত করা হল:
...
## <a id="table-of-contents">সুচিপত্র</a>
